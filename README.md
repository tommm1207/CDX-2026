...
- **Báo cáo chi phí**: Phân loại chi pháp theo nhóm, kho và nhân sự.

### 👥 Nhân sự & Tiền lương (HR & Payroll)
- **Chấm công**: Hệ thống điểm danh hàng ngày nhanh chóng.
- **Bảng lương tháng**: Tự động tính toán lương dựa trên công.

## 🛠 Công nghệ sử dụng
- **Vite & React**: Framework hiện đại cho hiệu năng cao.
