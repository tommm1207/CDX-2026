        ...
        >
          ...
          <div className="flex justify-between items-start mb-10 pb-6 border-b-2 border-primary/20">
            <div className="flex items-center gap-6">
              ...
              <div className="space-y-1">
                ...
                <div className="flex items-center gap-3 mt-2">
                  <span className="px-3 py-1 bg-green-50 text-green-600 rounded-full text-[10px] font-black uppercase tracking-widest border border-green-100 italic">Report Verified</span>
            ...
            <div className="text-right">
              <h2 className="text-3xl font-black text-gray-900 uppercase tracking-tighter mb-1">Báo Cáo Nhập Kho</h2>
              <p className="text-xs text-gray-500 font-bold italic">Thời gian xuất: {new Date().toLocaleString('vi-VN')}</p>
              <div className="mt-4 flex flex-col items-end gap-1">
                <p className="text-[10px] text-gray-400 font-bold uppercase tracking-widest font-mono">Status: LIVE_DATA</p>
          ...
          <table className="w-full text-left border-collapse rounded-3xl overflow-hidden shadow-sm border border-gray-100">
            ...
            <tbody className="divide-y divide-gray-100 text-sm">
              {(() => {
                ...
                return filteredList.map((item, idx) => (
                  <tr key={idx} className={idx % 2 === 0 ? 'bg-white' : 'bg-gray-50/30'}>
                    ...
                    <td className="px-4 py-3 text-xs font-black text-primary tracking-tight">{item.import_code}</td>
                    ...
                    <td className="px-4 py-3 text-xs font-black text-blue-600 text-center">{formatNumber(item.quantity)} {item.materials?.unit}</td>
              ...
              <tr className="bg-primary/5">
                <td colSpan={5} className="px-4 py-4 text-[11px] font-black text-primary uppercase text-right italic tracking-[0.1em]">Tổng cộng:</td>
                <td className="px-4 py-4 text-lg font-black text-primary text-right tabular-nums">
          ...
          <div className="mt-12 flex justify-between items-end border-t border-gray-100 pt-6">
            <div className="space-y-1">
              ...
              <p className="text-[9px] text-gray-300 font-bold uppercase tracking-widest">End of transaction report • Smart Logistics Flow</p>
            </div>
            <div className="text-right">
              <p className="text-[9px] font-black text-gray-300 uppercase tracking-[0.3em] mb-1">Generated by Secured Bot</p>
              <div className="text-[10px] text-gray-400 font-bold bg-gray-50 px-3 py-1 rounded-full border border-gray-100">
                Data Integrity Level: <span className="text-green-500 font-black tracking-widest italic ml-1 underline">SECURED</span>
              </div>
            </div>
          </div>
        </div>
