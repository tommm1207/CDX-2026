        ...
        <div ref={reportRef} className="p-8 bg-white" style={{ width: '1200px' }}>
          <div className="flex items-center justify-between mb-8 pb-4 border-b-2 border-primary/20">
            <div className="flex items-center gap-4">
              ...
              <div>
                <h1 className="text-2xl font-black text-gray-800 tracking-tight uppercase">DANH SÁCH LỆNH SẢN XUẤT</h1>
          ...
          <table className="w-full text-left border-collapse whitespace-nowrap">
            <thead>
              <tr className="bg-primary text-white">
                ...
                <th className="px-4 py-3 text-[10px] font-bold uppercase tracking-wider">Sản phẩm</th>
                <th className="px-4 py-3 text-[10px] font-bold uppercase tracking-wider text-center">SL Kế hoạch</th>
                <th className="px-4 py-3 text-[10px] font-bold uppercase tracking-wider text-center">Hoàn thành</th>
                <th className="px-4 py-3 text-[10px] font-bold uppercase tracking-wider">Kho vật tư</th>
                <th className="px-4 py-3 text-[10px] font-bold uppercase tracking-wider text-right">Ngày phát</th>
              </tr>
            </thead>
            <tbody>
              {filteredOrders.map((order) => (
                <tr key={order.id} className="border-b border-gray-100">
                  <td className="px-4 py-3.5 text-xs font-black text-primary uppercase">{order.ma_lenh}</td>
                  <td className="px-4 py-3.5 text-xs font-bold text-gray-800">{order.san_pham_bom?.ten_san_pham}</td>
                  <td className="px-4 py-3.5 text-xs font-black text-center text-gray-700">{order.so_luong_ke_hoach}</td>
                  <td className="px-4 py-3.5 text-xs font-black text-center text-green-600">{order.so_luong_hoan_thanh}</td>
                  <td className="px-4 py-3.5 text-xs font-bold text-gray-500">{order.warehouses?.name}</td>
                  <td className="px-4 py-3.5 text-xs text-right text-gray-400 italic">{formatDate(order.ngay_phat_lenh)}</td>
                </tr>
              ))}
            </tbody>
          </table>
