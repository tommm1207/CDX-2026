              ...
              {filteredReminders.map((rem, idx) => {
                ...
                return (
                  <tr key={idx} className={idx % 2 === 0 ? 'bg-white' : 'bg-gray-50/30'}>
                    ...
                    <td className="px-6 py-4">
                      <span
                        className={`px-2 py-0.5 rounded text-[8px] font-black uppercase italic ${isGlobal ? 'bg-blue-100 text-blue-600 border border-blue-200' : 'bg-purple-100 text-purple-600 border border-purple-200'}`}
                      >
          ...
          <div className="mt-12 flex justify-between items-end border-t border-gray-100 pt-6">
            <div className="space-y-1">
              ...
              <p className="text-[9px] text-gray-300 font-bold uppercase tracking-widest">
                End of communication report • Digital Infrastructure Hub
              </p>
            </div>
            <div className="text-right">
