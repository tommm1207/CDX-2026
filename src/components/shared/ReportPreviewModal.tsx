...
export const ReportPreviewModal = ({
  ...
  // Auto-scale based on screen width on initial load
  useEffect(() => {
    if (isOpen) {
      if (window.innerWidth < 640) setZoom(0.22);
      else if (window.innerWidth < 768) setZoom(0.4);
      else setZoom(0.5);
    }
  }, [isOpen]);
        ...
        <div className="fixed inset-0 z-[200] flex items-center justify-center p-4 md:p-8 no-print">
          ...
          >
            ...
            <div className="flex items-center justify-between px-6 py-4 bg-white border-b border-gray-100">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-[10px] text-gray-400 font-bold uppercase tracking-widest">Bản xem trước độ nét cao (4K)</p>
                </div>
              </div>
            ...
            <div className="flex-1 overflow-auto p-4 md:p-8 flex justify-center items-start bg-gray-200/50">
              ...
              >
                <div className="w-[1400px] pointer-events-none select-none">
                  {children}
                </div>
              </div>
            </div>
            ...
            <div className="px-8 py-6 bg-white border-t border-gray-100 flex items-center justify-between">
              <div className="hidden md:block">
                <p className="text-xs text-gray-500 font-medium">
                  <span className="font-bold text-primary">Lưu ý:</span> Ảnh sẽ được xuất với độ phân giải 4K (siêu nét).
                </p>
              </div>
